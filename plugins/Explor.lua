...
if ((matches[1] == "port2" and not Clang) or (matches[1] == "درگاه2" and Clang)) then
   if not lang then
     return "*2 month payday payment:*\nhttps://idpay.ir/megaplus/150000\nلطفا عکس را به ایدی زیر ارسال کنید\n@KingLonely\n@SajjadMazini\n@MeGaPlusSupportBot"..msg_caption
    elseif lang then
...
if ((matches[1] == "port3" and not Clang) or (matches[1] == "درگاه3" and Clang)) then
   if not lang then
     return "*3 month payday payment:*\nhttps://idpay.ir/megaplus/200000\nلطفا عکس را به ایدی زیر ارسال کنید\n@KingLonely\n@SajjadMazini\n@MeGaPlusSupportBot"..msg_caption
    elseif lang then
...
if (matches[1] == 'version' or matches[1] == "ورژن") and is_sudo(msg) then
   if not lang then
     return "*Robot Specification (Mega Plus)*\n\n`Version:` *TeleGramBot V 《 5.0 》*\n\n`Developer:`\n@kingLonely\n@SajjadMazini\n\n`Bot rules are enabled with the `*( botrules )* `command`"..msg_caption
    elseif lang then
       return "مشخصات ربات\n(مگا پلاس)\n\n`ورژن: `*TeleGramBot V《 5.0 》*\n\n`توسعه دهنده:`\n@kingLonely\n@SajjadMazini\n\n`دیدن قوانین ربات با دستور` `( قوانین ربات )` `میسر میشود`"..msg_caption
 end
 end
 if ((matches[1] == "nerkh" and not Clang) or (matches[1] == "نرخ" and Clang)) then
   if not lang then
     return "💵 *Nerkh Explor Bot*\n\n️ *For All Group*\n\n`️1 month 8 Toman `\n`️2 month 15 Toman`\n`️3 month 20 Toman`\n`️4 month 25 Toman`\n\n🔹 نکته مهم :\n\n`➖توجه داشته باشید ربات ما بدلیل سرعت بالا و امکانات فراوان ربات دائمی نداریم\n\n`جهت خرید اینترنتی *[ help6 ]* و خرید کارت به کارت *[ card number ]* را ارسال کنید"..msg_caption
    elseif lang then
       return "💵 نرخ ربات (اکسپلور) \n\n️ برای تمام گروه ها‌\n\n`1 ماهه8هزار تومان `\n`2 ماهه15هزار تومان`\n`3 ماهه20هزار تومان`\n`4 ماهه25هزار تومان`\n\n🔹 نکته مهم :\n\n`➖توجه داشته باشید ربات ما بدلیل سرعت بالا و امکانات فراوان ربات دائمی نداریم\n\n`جهت خرید اینترنتی  `[ راهنما 6 ]` و کارت به کارت `[ شماره کارت ]` را ارسال کنید"..msg_caption
 end
 end
