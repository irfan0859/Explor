...
--Begin Fun.lua By @ExplorCompany
--Special Thx To @explorsupportbot
--------------------------------
...
--------------------------------
 ...
 local text = matches[2]
  ...
  local file = download_to_file(url,'Explor.mp3')
 				tdbot.sendDocument(msg.to.id, file, msg_caption, nil, msg.id, 0, 1, nil, dl_cb, nil)
   end
end
...
▎‌`More Help` 
﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
🏅By: @KiarashNASA and @explorsupportbot
🏅Channel:
@ExplorCompany]]
else
...
▎‌ `راهنما سایرامکانات`
﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
🏅سازنده: @KiarashNASA and @explorsupportbot
🏅کانال ما:
@ExplorCompany]]
end
...
helpport_en = [[
*️راهنما درگاه های پرداختی  ﴿اکسپلور﴾ *
...
helpaddgp_en = [[
*️راهنما ادداجباری گروه  ﴿اکسپلور﴾ *
