...
bot_token = "553492941:AAFvfnAzpgKYgsi_nnyi6TENJ3h2SPy-1wQ" --Put You Token Here
...
function create_config( )
	...
	if server_user:match("^root$") then
		BeyondTeam = '/root/Explor'
	elseif not server_user:match("^root$") then
		BeyondTeam = '/home/'..server_user..'/Explor'
	end
  ...
  config = {
    ...
    sudo_users = {553712940,323311556,559152990},--Sudo users
    admins = {},
    disabled_channels = {},
    moderation = {data = ''..BeyondTeam..'/data/moderation.json'},
    info_text = [[Explor Bot 
