...
local lang = redis:get(hash) 
     if not lang then
	 text = 'به بخش اطلاعات گروه ربات  ﴿اکسپلور﴾  خوش آمدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		...
		{
			{text = '⚙️ Settings', callback_data = '/shelper:'..GP_id}
		},
		{
		...
		{
			{text = '✉️ Support', callback_data = '/support:'..GP_id},
			{text = '🎉 Explor', callback_data = '/Explor:'..GP_id}
		},
		{
			{text = '🏵️ Version 《V 5.0》', callback_data = '/v:'..GP_id}
		},
		{
  ...
  elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '✉️ پشتیبانی', callback_data = '/support:'..GP_id},
			{text = '🎉 اکسپلور', callback_data = '/Explor:'..GP_id}
		},
		{
			{text = '🏵 ورژن 《نسخه ۵.۰》', callback_data = '/v:'..GP_id}
		},
		{
    ...
    edit_inline(msg.message_id, 'به پنل مدیریتی ربات  ﴿اکسپلور﴾  خوشامدید\n\n❢ساعت  '..os.date("*%S : %M : %H*"), keyboard)
end
...
local settings = data[tostring(GP_id)]["settings"]
   if not lang then
 text = 'به تنظیمات سایر قفل ها  ﴿اکسپلور﴾  خوش آمدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = '● Flood Sensitivity', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="ExplorTeaM"},
			{text = "▼", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '● Character Sensitivity', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="ExplorTeaM"},
			{text = "▼", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '● Flood Check Time', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="ExplorTeaM"},
 ...
 text = 'به تنظیمات سایر قفل ها  ﴿اکسپلور﴾  خوش آمدید'
	...
	keyboard.inline_keyboard = {
		{
			{text = '● حداکثر پیام های مکرر', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="ExplorTeaM"},
		...
		{
			{text = '● حداکثر حروف مجاز', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="ExplorTeaM"},
		...
		{
			{text = '● زمان بررسی پیام های مکرر', callback_data = 'ExplorTeaM'}
		},
		{
			{text = "▲", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="ExplorTeaM"},
...
local lang = redis:get(hash) 
 ...
 text = 'به تنظیمات قفل ها  ﴿اکسپلور﴾  خوش آمدید'
	...
	keyboard.inline_keyboard = {
     ...
     elseif lang then
 text = 'به تنظیمات قفل ها  ﴿اکسپلور﴾  گروه خوش آمدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "ویرایش", callback_data='ExplorTeaM'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id},
			{text = "لینک", callback_data='ExplorTeaM'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "تگ", callback_data='ExplorTeaM'}, 
			{text = lock_tag, callback_data="/locktags:"..GP_id},
			{text = "ورود", callback_data='ExplorTeaM'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "فلود", callback_data='ExplorTeaM'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id},
			{text = "اسپم", callback_data='ExplorTeaM'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "فراخوانی", callback_data='ExplorTeaM'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id},
			{text = "عربی", callback_data='ExplorTeaM'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "وب", callback_data='ExplorTeaM'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id},
			{text = "فونت", callback_data='ExplorTeaM'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "سنجاق", callback_data='ExplorTeaM'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id},
			{text = "ربات", callback_data='ExplorTeaM'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		{
			{text = "خوشامد", callback_data='ExplorTeaM'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "گروه", callback_data='ExplorTeaM'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id},
			{text = "گیف", callback_data='ExplorTeaM'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "متن", callback_data='ExplorTeaM'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id},
			{text = "اینلاین", callback_data='ExplorTeaM'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "بازی", callback_data='ExplorTeaM'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id},
			{text = "عکس", callback_data='ExplorTeaM'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "فیلم", callback_data='ExplorTeaM'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id},
			{text = "آهنگ", callback_data='ExplorTeaM'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "صدا", callback_data='ExplorTeaM'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id},
			{text = "استیکر", callback_data='ExplorTeaM'}, 
			{text = mute_sticker, callback_data="/mutesticker:"..GP_id}
		},
		{
			{text = "مخاطب", callback_data='ExplorTeaM'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id},
			{text =  "فوروارد", callback_data='ExplorTeaM'}, 
			{text = mutes.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "موقعیت", callback_data='ExplorTeaM'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id},
			{text = "فایل", callback_data='ExplorTeaM'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "سرویس", callback_data='ExplorTeaM'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id},
			{text = "کیبورد", callback_data='ExplorTeaM'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '↫بازگشت', callback_data = '/shelper:'..GP_id}
...
if matches[1] == '/more' then
   ...
   elseif lang then
    ...
    if not lang then
		local text = 'به بخش اطلاعات گروه  ﴿اکسپلور﴾  خوش اومدین'
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
...
if matches[1] == '/shelper' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش تنظیمات ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش تنظیمات ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end
         -- ####################### TV ####################### --
if matches[1] == '/fun' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش سرگرمی ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش سرگرمی ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end  
         -- ####################### TV Iran ####################### --
if matches[1] == '/tviran' then 
   ...
   elseif lang then
    ...
    if not lang then
		local text = 'به بخش تلویزیون ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش تلویزیون ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 
         -- ####################### Satellite ####################### --
if matches[1] == '/satellite' then
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش ماهواره ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 
         -- ####################### Supprt ####################### --
if matches[1] == '/Explor' then
	if not is_mod1(matches[2], msg.from.id) then
     if not lang then
		get_alert(msg.cb_id, "✘No Admin✘")
   elseif lang then
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش مشخصات و اطلاعات سازنده ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 
...
》City : *Gorgan*
*-------------------------*
》Pv : @KiarashNASA and @explorsupportbot
》Bot : @ExplorSupportBot
*-------------------------*
*》Expertise :*
...
*-------------------------*]]
  if not lang then
		...
		keyboard.inline_keyboard = {
			{
				{text = "↬Back", callback_data="/Explor:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "↫برگشت", callback_data="/Explor:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
...
local text = [[قوانین ربات  ﴿اکسپلور﴾ 
...
روز خوبی داشته باشید با اکسپلور تیم
...
if matches[1] == '/support' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش پشتیبانی ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
		...
		},
		{
			...
			{text = '● SupportBot', url = 'https://t.me/Explorsupportbot'}
		},
		{
			{text = '● GpSupport', url = 'https://t.me/joinchat/E0VXxE8C7hME-x-h4iOGlg'},
			{text = '● BotChannel', url = 'https://t.me/Explorteam'}
		},
		{
			{text= '↬Back' ,callback_data = '/option:'..matches[2]}
		}				
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		},
		{
			...
			{text = '● پـیـامرسـان', url = 'https://t.me/Explorsupportbot'}
		},
		{
			{text = '● گپ پشتیبانی', url = 'https://t.me/joinchat/E0VXxE8C7hME-x-h4iOGlg'},
			{text = '● کـــانـال ربـات', url = 'https://t.me/Explorteam'}
		},
		{
			{text= '↫بازگشت' ,callback_data = '/option:'..matches[2]}
		}				
    ...
    edit_inline(msg.message_id,' به بخش پشتیبانی ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end
...
if matches[1] == '/cdev' then
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش تماس پشتیبانی ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 
         -- ####################### Shopping Bot ####################### --
if matches[1] == '/shopping' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش خرید خودکار ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
		...
		{
			{text = '● Month① ', url = 'https://idpay.ir/Explor/80000'},
			{text = '● Month②', url = 'https://idpay.ir/Explor/150000'}
		},
		{
			{text = '● Month③', url = 'https://idpay.ir/Explor/200000'},
			{text = '● Month④', url = 'https://idpay.ir/Explor/250000'}
		},
		{
			{text= '↬Back' ,callback_data = '/option:'..matches[2]}
		}				
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = '● مـــاهــه① ', url = 'https://idpay.ir/Explor/80000'},
			{text = '● مـــاهــه②', url = 'https://idpay.ir/Explor/150000'}
		},
		{
			{text = '● مـــاهــه③', url = 'https://idpay.ir/Explor/200000'},
			{text = '● مـــاهــه④', url = 'https://idpay.ir/Explor/250000'}
		},
		{
			{text= '↫بازگشت' ,callback_data = '/option:'..matches[2]}
		}				
    ...
    edit_inline(msg.message_id,' به بخش خرید خودکار ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 

if matches[1] == '/nerkh' then
local text = [[💵 نرخ ربات  ﴿اکسپلور﴾  
...
local text = [[ربات ضد اسپم یا ضد لینک  ﴿اکسپلور﴾  هم میتواند مانند یکی از ادمینهای یک سوپر گروه کار کند و گروهتان را مدیریت کند
    کاربرد ربات ضد اسپم  ﴿اکسپلور﴾  میتواند خیلی چیزا مانند مدیرتی یا تفریحی باشد
...
local text = [[شماره کارت جهت خرید ربات انتی اسپم ‌﴿اکسپلور﴾
...
if matches[1] == '/helpen' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش راهنما انگلیسی ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش راهنما انگلیسی ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 

if matches[1] == '/helpsudo' then
local text = [[*Explor Sudo  Help*
...
﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
🏅By: @explorsupportbot and @KiarashNASA
🏅Channel: 
@ExplorTeaM]]
  if not lang then
		keyboard = {} 
...
local text = [[*Explor MediaLock Help*
...
local text = [[*Explor Payment gateway Help*
...
local text = [[*Explor GpAddUser  Help*
...
if matches[1] == '/helpfa' then
   ...
   elseif lang then
    ...
    if not lang then
	local text = 'به بخش راهنما فارسی ربات  ﴿اکسپلور﴾  خوش امدید'
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
   ...
   elseif lang then
    ...
    edit_inline(msg.message_id,' به بخش راهنما فارسی ربات  ﴿اکسپلور﴾  خوش امدید', keyboard)
	end
end 

if matches[1] == '/helpsudofa' then
local text = [[*راهنما سودو  ﴿اکسپلور﴾ *
...
﹏﹏﹏﹏﹏﹏﹏﹏﹏﹏
🏅سازنده: @explorsupportbot and @KiarashNASA
🏅کانال ما:
@ExplorTeaM]]
  if not lang then
		keyboard = {} 
...
local text = [[*راهنما قفلی  ﴿اکسپلور﴾ *
...
local text = [[*راهنما قفل رسانه  ﴿اکسپلور﴾ *
...
local text = [[*راهنما مدیریتی  ﴿اکسپلور﴾ *
...
local text = [[*راهنما سرگرمی  ﴿اکسپلور﴾ *
...
local text = [[*راهنما درگاه های پرداختی  ﴿اکسپلور﴾ *
...
local text = [[*راهنما ادداجباری گروه  ﴿اکسپلور﴾ *
...
local text = [[*راهنما سایرامکانات (اکسپلور)*
...
if matches[1] == '/exit' then
   ...
   elseif lang then
    ...
    if not lang then
		 text = '`Explor Group Menu Closed`'
   elseif lang then
		 text = '`پنل مدیریتی ربات  ﴿اکسپلور﴾  بسته شد`'
